...
const Settings = () => {
  ...
  return (
    <div className="overflow-auto h-full">
      <Title className="text-xl lg:text-3xl px-5 py-5" variant="inverse">
        {commons.settings.title}
      </Title>

      <div className="h-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-14 px-5">
        ...
        <form className="flex w-full flex-col gap-3 pb-10">
