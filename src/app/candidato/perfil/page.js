  ...
  return (
    <div className="flex flex-row">
      ...
      >
        ...
        <Title className="hidden mb-3 lg:block lg:text-2xl lg:mb-5">Perfil</Title>
        <Card
          className={twMerge(
        ...
        >
          ...
          <div>
            <div className="flex flex-col justify-center items-center my-5 relative lg:flex-row lg:justify-between lg:mt-0">
              ...
              <div>
                <div className="flex flex-col items-center lg:items-start">
                  <Title variant="inverse" className="text-base lg:text-xl">
                    Helena Berlone
                  </Title>
                  <Title variant="inverse" className="text-sm lg:text-base">
                    UI Design
                  </Title>
                </div>

                <section className="my-6 self-start">
                  <Title variant="inverse" className="text-base">
                    Descrição
                  </Title>
            ...
            <section className="mb-10 order-0">
              <Title variant="inverse" className="text-base mb-2">
                Últimas Empresas
              </Title>

              <Quote className="mb-8">
                <Title variant="inverse" className="text-sm">
                  Fiap LTDA
                </Title>
