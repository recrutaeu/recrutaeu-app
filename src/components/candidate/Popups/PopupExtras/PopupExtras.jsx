...
const PopupExtras = withTheme(({ className, variant = 'default', editItem, ...props }) => {
  return (
    <form className="flex flex-col gap-4">
      <InputLabel placeholder="ex: Wizard" label="Nome da instituição:" className="" variant='inverseSecundary'/>
      <InputLabel placeholder="ex: Inglês Avançado" label="Curso:" className="" variant='inverseSecundary'/>
      <DataPicker />
